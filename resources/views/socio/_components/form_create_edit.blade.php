<div class="flex items-end">
    ...
    <div class="grid gap-4 sm:gap-6">
        <div>
            ...
            <x-text-input placeholder="Insira o nome" name="nome" id="nome"
                value="{{ $socio->nome ?? old('nome') }}" type="text" class="w-full" />
        ...
        <div>
            <label for="data_admissao" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Data de
                Admissão</label>
            <x-text-input placeholder="Insira a Data de Admissão" name="data_admissao" id="data_admissao" type="date"
                value="{{ $socio->data_admissao ?? old('data_admissao') }}" />
        ...
        <div>
            ...
            <select name="estado_civil" id="estado_civil" placeholder="Selecione o Estado Civil">
                ...
                @foreach (\App\Enums\EstadoCivil::cases() as $estado_civil)
                    <option value="{{ $estado_civil->value }}"
                        {{ isset($socio->estado_civil->value) == $estado_civil->value || old('estado_civil') == $estado_civil->value ? 'selected' : '' }}>
                        {{ $estado_civil->value }} </option>
                @endforeach
            </select>
        ...
        <div>
            ...
            <div class="flex">
                <div class="flex items-center mr-4">
                    <input id="eleitor" type="radio" value="{{ 1 }}"
                        {{ isset($socio->eleitor) == 1 ? 'checked' : '' }} name="eleitor"
                ...
                <div class="flex items-center mr-4">
                    <input id="eleitor-nao" type="radio" value="{{ 0 }}"
                        {{ isset($socio->eleitor) && $socio->eleitor == 0 ? 'checked' : '' }} name="eleitor"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        ...
        <div>
            ...
            <div class="flex">
                <div class="flex items-center mr-4">
                    <input id="escritura_prop" type="radio" value="{{ 1 }}"
                        {{ isset($socio->escritura_prop) && $socio->escritura_prop == 1 ? 'checked' : '' }}
                        name="escritura_prop"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="flex items-center mr-4">
                    <input id="escritura_prop-nao" type="radio" value="{{ 0 }}"
                        {{ isset($socio->escritura_prop) && $socio->escritura_prop == 0 ? 'checked' : '' }}
                        name="escritura_prop"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="escritura_prop"
        ...
        <div>
            ...
            <div class="flex">
                <div class="flex items-center mr-4">
                    <input id="cadastrado" type="radio" value="{{ 1 }}"
                        {{ isset($socio->cadastrado) && $socio->cadastrado == 1 ? 'checked' : '' }} name="cadastrado"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="cadastrado"
                        class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Sim</label>
                </div>
                <div class="flex items-center mr-4">
                    <input id="cadastrado-nao" type="radio" value="{{ 0 }}"
                        {{ isset($socio->cadastrado) && $socio->cadastrado == 0 ? 'checked' : '' }} name="cadastrado"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="cadastrado"
                        class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Não</label>
                </div>
        ...
        <div>
            ...
            <div class="flex">
                <div class="flex items-center mr-4">
                    <input id="assalariado" type="radio" value="{{ 1 }}"
                        {{ isset($socio->assalariado) && $socio->assalariado == 1 ? 'checked' : '' }}
                        name="assalariado"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="assalariado"
                        class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Sim</label>
                ...
                <div class="flex items-center mr-4">
                    <input id="assalariado-nao" type="radio" value="{{ 0 }}"
                        {{ isset($socio->assalariado) && $socio->assalariado == 0 ? 'checked' : '' }}
                        name="assalariado"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="assalariado"
                        class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Não</label>
        ...
        <div>
            ...
            <div class="flex">
                <div class="flex items-center mr-4">
                    <input id="carteira_assinada" type="radio" value="{{ 1 }}"
                        {{ isset($socio->carteira_assinada) && $socio->carteira_assinada == 1 ? 'checked' : '' }}
                ...
                <div class="flex items-center mr-4">
                    <input id="carteira_assinada-nao" type="radio" value="{{ 0 }}"
                        {{ isset($socio->carteira_assinada) && $socio->carteira_assinada == 0 ? 'checked' : '' }}
                        name="carteira_assinada"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="carteira_assinada"
                        class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Não</label>
        ...
        <div>
            <label for="salario" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"> Salário
                Quanto:</label>
            R$ <x-text-input placeholder="Salário Quanto?" name="salario" id="salario"
        ...
        <div>
            ...
            <x-text-input placeholder="Insira o Telefone" name="telefone" id="telefone"
                value="{{ $socio->telefone ?? old('telefone') }}" type="text" class="w-full" />
            <x-input-error :messages="$errors->get('telefone')" class="mt-2" />
        </div>
        <div>
            <label for="propriedade_de"
                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Propriedade
                de:</label>
        ...
        <div>
            ...
            <x-text-input placeholder="Insira a Data da Emissão" name="data_emissao" id="data_emissao"
                value="{{ $socio->data_emissao ?? old('data_emissao') }}" type="date" />
        ...
        <div>
            ...
            <x-text-input placeholder="Insira o RG" name="rg" id="rg"
                value="{{ $socio->rg ?? old('rg') }}" type="text" />
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        var element = document.getElementById('salario');
