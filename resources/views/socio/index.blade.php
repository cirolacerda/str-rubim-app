                    ...
                    <table class="min-w-max w-full table-auto">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-6 text-left">DATA ADMISSÃO</th>
                                <th class="py-3 px-6 text-left">NOME</th>
                                <th class="py-3 px-6 text-center">RG</th>
                                <th class="py-3 px-6 text-center">CPF</th>
                                <!--  <th class="py-3 px-6 text-center">STATUS</th> -->
                                <th class="py-3 px-6 text-center">FICHA</th>
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    <td class="py-3 px-6 text-left whitespace-nowrap">
                                        <div class="flex items-center">
                                            <span class="font-medium">{{ $socio->matricula }}</span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="py-3 px-6 text-left">
                                        <div class="w-4 mr-2 transform hover:text-blue-800 hover:scale-110">
                                            <a href="{{ route('socios.fichaWord', ['socio' => $socio->id]) }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                    fill="currentColor" class="bi bi-file-earmark-word"
                                                    viewBox="0 0 16 16">
                                                    <path
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex item-center justify-center">
                                            <div class="w-4 mr-2 transform hover:text-blue-500 hover:scale-110">
                                                <a href="{{ route('socios.show', ['socio' => $socio->id]) }}">
                                            ...
                                            <div class="w-4 mr-2 transform hover:text-blue-500 hover:scale-110">
                                                <a href="{{ route('socios.edit', ['socio' => $socio->id]) }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                        height="20" fill="none" viewBox="0 0 24 24"
                                                        stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <div class="w-4 mr-2 transform hover:text-red-500 hover:scale-110">
                                                <form id="form_{{ $socio->id }}"
                                                    action="{{ route('socios.destroy', ['socio' => $socio->id]) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <label
                                                        onclick="document.getElementById('form_{{ $socio->id }}').submit()">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                            height="20" fill="none" viewBox="0 0 24 24"
                                                            stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
